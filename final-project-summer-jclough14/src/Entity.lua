...
function Entity:init(def)
    ...
    self.powerupMachine = def.powerupMachine
...
function Entity:changepowerupState(state, params)
    self.powerupMachine:change(state, params)
end

function Entity:update(dt)
    
    if self.powerupMachine then
        self.powerupMachine:update(dt)
    end
