...
require 'src/states/entity/PlayerNormalState'
...
gTextures = {
    ...
    ['fire-alien'] = love.graphics.newImage('graphics/fire_alien.png'),
...
gFrames = {
    ...
    ['fire-alien'] = GenerateQuads(gTextures['fire-alien'], 16, 20),
    ['creatures'] = GenerateQuads(gTextures['creatures'], 16, 16),
    ['flags'] = GenerateQuads(gTextures['flags'], 16, 16),
    ['flagpole'] = GenerateQuads(gTextures['flagpole'], 16, 48),
